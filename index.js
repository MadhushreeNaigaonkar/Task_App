...
const generateHTML = (taskData) =>
  ...
  <div class="card bg-white">
    <div class="card-header d-flex justify-content-end gap-2">
      <button type="button" class="btn btn-outline-dark" onclick="editCard.apply(this, arguments)">
    ...
    <div class="card-footer">
        <button type="button" class="btn btn-outline-dark" name=${taskData.id} data-bs-toggle ="modal" data-bs-target="#showTask" onclick="openTask.apply(this , arguments)">
          Open Task
        </button>
      </div>
  </div>
